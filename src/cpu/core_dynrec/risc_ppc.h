...
static const Bit8u* gen_create_branch_long_nonzero(HostReg reg,bool dword)
{
	if (!dword)
...
static void gen_function(const void* func)
{
...
static const Bit8u* epilog_addr;
static const Bit8u *getCF_glue;
static void gen_run_code(void)
{
	...
	gen_function((const void*)get_CF);
}
