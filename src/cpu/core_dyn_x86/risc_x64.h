...
static BlockReturn gen_runcodeInit(const Bit8u *code) {
	...
	// mov rbp, &cpu_regs
#if 1
	//DBP: Added fix for crashing builds by VS2019 and newer from DOSBox-X by Jonathan Campbell
	//     Source: https://github.com/joncampbell123/dosbox-x/commit/15d5114
	//     Source: https://github.com/joncampbell123/dosbox-x/commit/d4474a8
